...
//		camperEnterVehicleData= new pages.Camper.EnterVehicleData(dr);
	...
	public void testTruckPage() throws Exception {
		...
		Assert.assertTrue(automobileEnterVehicleData.isEnginePerformancePresent(),
				"Engine Performance field is not displayed");
		...
		Assert.assertTrue(automobileEnterVehicleData.isDateOfManufacturePresent(),
				"Date Of Manufacture field is not displayed");
		...
		Assert.assertTrue(automobileEnterVehicleData.isLicensePlateNumber(),
				"License PlateNumber field is not displayed");
...
//		PAGE#2 Of Camper TAB: Enter Insurant Data
		...
		Assert.assertTrue(automobileEnterInsurantData.isStreetAddressPresent(),
				"enter street address field is not displayed");
...
//			PAGE#4 Of Truck TAB: Select Price Option
		...
		FileHandler.copy(src,
				new File("E:\\Automation\\GitRepo\\AutomationFramework\\Screenshots\\testing_" + name + ".png"));
