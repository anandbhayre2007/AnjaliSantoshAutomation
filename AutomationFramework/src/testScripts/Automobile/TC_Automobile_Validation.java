...
//		camperEnterVehicleData= new pages.Camper.EnterVehicleData(dr);
	...
	public void testTruckPage() throws Exception {
		...
		automobileEnterInsurantData.enterAutomobileInsurantData();
		automobileEnterProductData.enterAutomobileProductData();
		 ...
		 * Assert.assertTrue(automobileEnterVehicleData.isMakePresent(),
		 * "Make field is not displayed"); // Step 4: Verify that MAKE field link is
		 * working String make=xlLib.getCelllData("Automobile", 1, 0);
		 ...
		 * "License PlateNumber field is not displayed"); // Step 16: Verify that
		 ...
		 * Assert.assertTrue(automobileEnterInsurantData.isFirstNamePresent(),
		 ...
		 * Assert.assertTrue(automobileEnterInsurantData.isGenderFemalePresent(),
		 ...
		 * Assert.assertTrue(automobileEnterInsurantData.isBungeeJumpingPresent(),
		 * "Bungee Jumping field is not displayed");
		 * Assert.assertTrue(automobileEnterInsurantData.isCliffDivingPresent(),
		 * "Cliff Diving field is not displayed");
		 * Assert.assertTrue(automobileEnterInsurantData.isSkyDivingPresent(),
		 * "Sky Diving field is not displayed");
		 * Assert.assertTrue(automobileEnterInsurantData.isOtherPresent(),
		 ...
		 * Assert.assertTrue(automobileEnterInsurantData.isOpenPresent(),
		 ...
		 * Assert.assertTrue(automobileEnterProductData.isStartDatePresent(),
		 ...
		 * "merit rating field is not displayed"); // Step 52: Verify that Insurance Sum
		 * is displayed automobileEnterProductData.enterMeritRating(2); ;
		 * 
		 * // Step 53: Verify that Damage Insurance is displayed
		 * Assert.assertTrue(automobileEnterProductData.isDamageInsurancePresent(),
		 * "Damage Insurance field is not displayed"); // Step 54: Verify that Damage
		 ...
		 * are // displayed
		 * Assert.assertTrue(automobileEnterProductData.isEuroProtection(),
		 ...
		 * 
		 * // Step 60: Verify that Silver,Gold,Platinum and Ultimate radio buttons are
		 * // displayed Assert.assertTrue(automobileSelectPriceOption.isselectsilver(),
		 * "Silver Radio Button is not displayed");
		 * Assert.assertTrue(automobileSelectPriceOption.isselectgold(),
		 * "Gold Radio Button is not displayed");
		 * Assert.assertTrue(automobileSelectPriceOption.isselectplatinum(),
		 * " Platinum Radio Button is not displayed");
		 * Assert.assertTrue(automobileSelectPriceOption.isselectultimate(),
		 ...
		 * "Username field is not displayed"); // Step 77: Verify that Send Button is
		 * working automobileSendQuote.clickSendEMail();
		 * 
		 * Thread.sleep(25000);
		 * 
		 * // Step 78 taking ScreenShot TakesScreenshot screenshot = (TakesScreenshot)
		 * dr; File src = screenshot.getScreenshotAs(OutputType.FILE);
		 * 
		 * String name = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
		 * FileHandler.copy(src, new
		 * File("E:\\Automation\\GitRepo\\AutomationFramework\\Screenshots\\testing_" +
		 * name + ".png"));
		 */
	}
}
